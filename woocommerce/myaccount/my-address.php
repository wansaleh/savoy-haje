...
<h1 class="mb-3"><?php esc_html_e( 'Addresses', 'savoy-haje' ); ?></h1>

<p class="woocommerce-Message woocommerce-Message--info woocommerce-info">
	<?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( 'The following addresses will be used on the checkout page by default.', 'woocommerce' ) ); ?>
</p>

<?php if ( $nm_shipping_address_enabled ) echo '<div class="u-columns woocommerce-Addresses col2-set addresses"><div class="nm-row">'; ?>

<?php foreach ( $get_addresses as $name => $title ) : ?>

	<div class="woocommerce-Address <?php echo $nm_column_class; ?>">
...
<?php if ( $nm_shipping_address_enabled ) echo '</div></div>'; ?>
